...
import GymApplicationForm from './GymApplicationForm';
...
const GymApplicationProcess= ({clubId}:{clubId:string}) => {
  ...
  return (
    <>
     {currentStep === 0 && < GymApplicationForm 
...
export default GymApplicationProcess;